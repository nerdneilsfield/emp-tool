...
public:
  ...
  template <typename T> Integer(int length, T *input, int party = PUBLIC);

  template <typename T> Integer(T *input, int party = PUBLIC);
  ...
  template <typename T> void reveal(T *output, const int party = PUBLIC) const;
