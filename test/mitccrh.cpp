...
int main() {
  ...
  cout << 1024 * 1024 * 10 * 2 / (time_from(start)) * 1e6 << " blocks/second"
       << endl;
  ...
  cout << 1024 * 1024 * 10 * 4 / (time_from(start)) * 1e6 << " blocks/second"
       << endl;
  ...
  cout << 1024 * 1024 * 10 * 8 / (time_from(start)) * 1e6 << " blocks/second"
       << endl;
